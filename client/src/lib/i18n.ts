  ...
  fr: {
    ...
    seo: {
      ...
      contact: {
        ...
        keywords: 'contact Altus Finances Group, nous contacter, service client prêt, aide financement entreprise, support client Altus',
      },
      howItWorks: {
    ...
    premiumTestimonials: {
      ...
      testimonial2Content: 'Grâce à Altus Finances Group, j\'ai pu financer le développement de mon entreprise. Un accompagnement personnalisé du début à la fin.',
