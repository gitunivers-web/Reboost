...
export const translations: Record<Language, TranslationKeys> = {
  ...
  pt: {
    ...
    auth: {
      ...
      loginSuccessDesc: 'Bem-vindo ao ALTUS',
      ...
      signupError: 'Erro',
      signupErrorDesc: 'Ocorreu um erro durante o registro',
      ...
      companyRequired: 'O nome da empresa é obrigatório para contas empresariais',
  ...
  it: {
    ...
    auth: {
      ...
      loginErrorDesc: 'Email o password errata',
      signupError: 'Errore',
      ...
      companyNamePlaceholder: 'Azienda SRL',
      siretPlaceholder: '123 456 789 00010',
      required: 'obbligatorio',
      companyRequired: 'Il nome dell\'azienda è obbligatorio per gli account aziendali',
  ...
  de: {
    ...
    auth: {
      ...
      loginErrorDesc: 'Falsche E-Mail oder Passwort',
      signupError: 'Fehler',
  ...
  nl: {
    ...
    auth: {
      title: 'ALTUS',
      subtitle: 'Uw vertrouwde partner voor financiering',
      loginTab: 'Inloggen',
      ...
      personalLoan: 'Persoonlijke lening',
      business: 'Zakelijk/Professioneel',
