...
export const translations: Record<Language, TranslationKeys> = {
  fr: {
    ...
    howItWorks: {
      ...
      step3Title: 'Demande de prêt - Depuis votre espace',
      step3Desc: 'Soumettez votre demande de prêt directement depuis votre espace utilisateur. Remplissez le formulaire avec le montant souhaité, téléchargez vos documents justificatifs. Notre technologie analyse votre profil et vous donne une réponse de principe en 24 à 48h.',
      step4Title: 'Déblocage et transfert - Sous 7 à 15 jours',
      step4Desc: 'Une fois votre demande approuvée, signez électroniquement votre contrat depuis votre espace. Les fonds sont débloqués sur votre compte sécurisé Altus Finance Group, puis transférés vers votre compte bancaire personnel ou professionnel sous 7 à 15 jours.',
  ...
  es: {
    ...
    howItWorks: {
      ...
      step3Title: 'Solicitud de préstamo - Desde su panel',
      step3Desc: 'Envíe su solicitud de préstamo directamente desde su panel de usuario. Complete el formulario con el monto deseado y cargue sus documentos justificativos. Nuestra tecnología analiza su perfil y le da una respuesta de aprobación en 24 a 48 horas.',
      step4Title: 'Desembolso y transferencia - En 7 a 15 días',
      step4Desc: 'Una vez aprobada su solicitud, firme electrónicamente su contrato desde su panel. Los fondos se liberan en su cuenta segura Altus Finance Group, luego se transfieren a su cuenta bancaria personal o empresarial en 7 a 15 días.',
  ...
  pt: {
    ...
    howItWorks: {
      ...
      step3Title: 'Solicitação de empréstimo - Do seu painel',
      step3Desc: 'Envie sua solicitação de empréstimo diretamente do seu painel de usuário. Preencha o formulário com o valor desejado e carregue seus documentos justificativos. Nossa tecnologia analisa seu perfil e dá uma resposta de aprovação em 24 a 48 horas.',
      step4Title: 'Liberação e transferência - Em 7 a 15 dias',
      step4Desc: 'Assim que sua solicitação for aprovada, assine eletronicamente seu contrato do seu painel. Os fundos são liberados em sua conta segura Altus Finance Group, depois transferidos para sua conta bancária pessoal ou empresarial em 7 a 15 dias.',
    },
    products: {
  ...
  it: {
    ...
    howItWorks: {
      ...
      step3Title: 'Richiesta di prestito - Dal tuo pannello',
      step3Desc: 'Invia la tua richiesta di prestito direttamente dal tuo pannello utente. Compila il modulo con l\'importo desiderato e carica i tuoi documenti giustificativi. La nostra tecnologia analizza il tuo profilo e ti dà una risposta di approvazione entro 24-48 ore.',
      step4Title: 'Sblocco e trasferimento - Entro 7-15 giorni',
      step4Desc: 'Una volta approvata la tua richiesta, firma elettronicamente il tuo contratto dal tuo pannello. I fondi vengono sbloccati sul tuo conto sicuro Altus Finance Group, poi trasferiti sul tuo conto bancario personale o aziendale entro 7-15 giorni.',
    },
    products: {
  ...
  de: {
    ...
    howItWorks: {
      ...
      step3Title: 'Kreditantrag - Über Ihr Dashboard',
      step3Desc: 'Stellen Sie Ihren Kreditantrag direkt über Ihr Benutzerdashboard. Füllen Sie das Formular mit dem gewünschten Betrag aus und laden Sie Ihre Belege hoch. Unsere Technologie analysiert Ihr Profil und gibt Ihnen innerhalb von 24 bis 48 Stunden eine Genehmigungsantwort.',
      step4Title: 'Freigabe und Überweisung - Innerhalb von 7 bis 15 Tagen',
      step4Desc: 'Sobald Ihr Antrag genehmigt ist, unterschreiben Sie Ihren Vertrag elektronisch über Ihr Dashboard. Die Mittel werden auf Ihr sicheres Altus Finance Group-Konto freigegeben und dann innerhalb von 7 bis 15 Tagen auf Ihr persönliches oder geschäftliches Bankkonto überwiesen.',
    },
    products: {
