...
export default function AppSidebar() {
  ...
  return (
    <Sidebar>
      <SidebarContent>
        <SidebarGroup>
          <div className="px-4 py-6 mb-4 flex items-center justify-center gap-4" data-testid="sidebar-logo">
            <img 
              src={logoUrl} 
            ...
            <div className="flex flex-col">
              <span className="text-sidebar-foreground text-2xl font-bold tracking-tight">ALTUS</span>
              <span className="text-sidebar-foreground text-base font-semibold tracking-wide">FINANCE</span>
            </div>
          </div>
